      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card border-0 shadow">
            ...
            <div class="card-body">
              ...
              <p class="h4 font-weight-bold mb-3">Em dúvida do curso? A gente ajuda!</p>
        ...
        <div class="col-md-4">
          <div class="card border-0 shadow">
            <img class="img-fluid mb-2 rounded" src="https://placeimg.com/800/400/tech" alt="Card image">
            <div class="card-body">
              <div class="mb-3 category-mba"><span class="py-1 px-2 tag rounded text-uppercase mb-2 text-white">MBA</span>
              </div>
              <p class="h4 font-weight-bold mb-3">Em dúvida do curso? A gente ajuda!</p>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis id dolores nesciunt debitis saepe facilis nam tenetur aperiam fugit reprehenderit commodi officia eligendi temporibus quis, ratione earum odit provident? Error!</p>
              <a href="#" class="btn btn-primary btn-block btn-lg">Baixar agora</a>
        ...
        <div class="col-md-4">
          <div class="card border-0 shadow">
            <img class="img-fluid mb-2 rounded" src="https://placeimg.com/800/400/tech" alt="Card image">
            <div class="card-body">
              <div class="mb-3 category-graduacao"><span class="py-1 px-2 tag rounded text-uppercase mb-2 text-white">Graduação</span>
              </div>
              <p class="h4 font-weight-bold mb-3">Em dúvida do curso? A gente ajuda!</p>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis id dolores nesciunt debitis saepe facilis nam tenetur aperiam fugit reprehenderit commodi officia eligendi temporibus quis, ratione earum odit provident? Error!</p>
              <a href="#" class="btn btn-primary btn-block btn-lg">Baixar agora</a>
